...
@section('content')
    <section id="about-us" class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                    ...
                    <div class="maapadmabuilding">
                        ...
                        <img class="img-responsive" src="images/team_asia.png" alt="Asia Link Services" />
        ...
        <div class="row">
            <div class="col-sm-6">
                <img class="img-responsive" src="images/vision-mission.jpg" alt="AsiaLink Services" />
            ...
            <div class="col-md-6 col-xs-6">
                <div class="center">
                    <p>
                        ...
                        <img style="padding-left:70px;" class="img-responsive" src="images/asialink_facts.png" alt="Asia Link Services Facts" ></p>
