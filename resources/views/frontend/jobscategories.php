...
<head>
    ...
    <title>Jobs Categories| AsiaLink Services</title>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p> <img style="padding-top:20px;" class="img-rounded" src="images/jobs/hotel.jpg" height="250" width="250" /></p>
                        </div>
                    </div>
                </div><!--/.col-md-4-->
                <div class="col-md-4 col-sm-6">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>
                             ...
                             <p> <img style="padding-top:20px;" class="img-rounded" src="images/jobs/construction.jpg" height="250" width="250" /></p>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>
                             ...
                             <p> <img style="padding-top:20px;" class="img-rounded" src="images/jobs/sales.jpg" height="250" width="250" /></p>
                        </div>
                    </div>
                </div><!--/.col-md-4-->
            </div><!--/.row-->
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>
                             ...
                             <p> <img style="padding-top:20px;" class="img-rounded" src="images/jobs/security.jpg" height="275" width="250" /></p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p> <img style="padding-top:20px;" class="img-rounded" src="images/jobs/caregiver.jpg" height="275" width="250" /></p>
                        </div>
                    </div>
                </div><!--/.col-md-4-->
                <div class="col-md-4 col-sm-6">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p> <img style="padding-top:20px;" class="img-rounded" src="images/jobs/staff.jpg" height="275" width="250" /></p>
                        </div>
                    </div>
                </div><!--/.col-md-4-->
            </div><!--/.row-->
