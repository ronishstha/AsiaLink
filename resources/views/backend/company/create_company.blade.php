                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form action="{{ route('backend.company.post.create') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" name="location" id="location" value="{{ Request::old('location') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" name="country" id="country" value="{{ Request::old('country') }}">
                                    </div>
                                </div>
